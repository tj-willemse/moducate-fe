          ...
          <div class="space-y-6">
            <div class="flex items-start">
              ...
              <div class="ml-3 text-sm">
                ...
                <p class="text-gray-500">Receive email notifications when new assessments are submitted for moderation.</p>
              </div>
            </div>
            ...
            <div class="flex items-start">
              ...
              <div class="ml-3 text-sm">
                ...
                <p class="text-gray-500">Receive browser notifications when new assessments are submitted for moderation.</p>
              </div>
            </div>
            ...
            <div class="flex items-start">
              ...
              <div class="ml-3 text-sm">
                <label for="summary-notifications" class="font-medium text-gray-700">Daily summary</label>
                <p class="text-gray-500">Receive a daily summary of all assessments pending moderation.</p>
              </div>
            </div>
